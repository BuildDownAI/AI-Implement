...
<section data-page="projects" hidden>
  ...
  <div class="page-body">
    ...
    <div class="card hidden" id="secrets-panel">
      ...
      <div class="card-body">
        <div class="warning">&#9888; Secrets are shared across all machines for this team, values are write-only. Secrets reach setup, verify, teardown, and preflight scripts, plus dependency install; the agent never sees them.</div>
        <table class="tbl">
          <thead>
